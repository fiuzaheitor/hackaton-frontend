...
import './styles.scss';
import { useGetConsultations, useGetConsultationsByGestation, useGetGestationsByUser, useGetKidsByMom, useGetVaccineCardByKid, useGetVaccinesByVaccineCard } from "../../utils/Queries";
