    ...
    <div className={`popup__overlay`}>
      <div className="popup__content">
        ...
        <div className="popup__body">
          <p>{description}</p>
          <Button type="button" text="Confirmar" onClick={() => handleConfirm()} />
        </div>
      </div>
    </div>
  );
...
export const PopupWeek: React.FC<{
    title?: string;
    onClick: any;
    dateInput?: boolean;
    showPopup?: boolean;
    setShowPopup?: any;}> = ({ title, onClick, dateInput, showPopup, setShowPopup}) => {
...
export const PopupComplete: React.FC<{
    title?: string;
    onClick: any;
...
export const PopupKid: React.FC<{
    title?: string;
    onClick: any;
    showPopup?: boolean;
    setShowPopup?: any;}> = ({ title, onClick, showPopup, setShowPopup}) => {
    const [value, setValue] = useState('')
    ...
    return (
        <div className={`popup__overlay`}>
            <div className="popup__content">
                ...
                <div className="popup__body">
                    <div className="popup__input">
                       <Input placeholder="Nome da criança" label="Nome da criança" type="text" value={value} onChange={(e) => setValue(e.target.value)}/>
                    </div>
                    <Button type="button" text="Confirmar" onClick={handleSubmit}/>
                </div>
            </div>
